...
namespace LiteDB
{
    ...
    class UnExpectedTokenLiteException : LiteDB.LiteException
    {
        public UnExpectedTokenLiteException(string tk)
            : base("unexpected token " + tk)
        {
            this.Token = tk;
        }
    ...
    internal class JsonToken
    {
        ...
        public void Expect(JsonTokenType type)
        {
            ...
            {
                throw new UnExpectedTokenLiteException(this.Token);
            }
        }
